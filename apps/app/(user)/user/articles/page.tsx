...
import { Search, Filter, MoreHorizontal, Clock, Bookmark, Eye } from "lucide-react";
...
const mockArticles: Article[] = [
  {
    ...
    excerpt:
      "Les avancées technologiques transforment radicalement le paysage économique mondial...",
    category: "Économie",
  ...
  {
    id: "4",
    title: "La crise énergétique: soluciones pour demain",
    ...
    <div className="p-6 space-y-6">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Consultez et gérez vos articles préférés</p>
        </div>
      </div>
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        ...
                        <DropdownMenuItem onClick={() => toggleBookmark(article.id)}>
                          <Bookmark className="mr-2 h-4 w-4" />
                          {article.isBookmarked ? "Retirer des favoris" : "Ajouter aux favoris"}
                        </DropdownMenuItem>
                      </DropdownMenuContent>
                    </DropdownMenu>
                  </div>
