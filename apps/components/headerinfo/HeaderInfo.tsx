...
import { HeaderInfoSearch } from "@/components/headerinfo/HeaderInfoSearch";
import { HeaderInfoThemeToggle } from "@/components/headerinfo/HeaderInfoThemeToggle";
...
export async function HeaderInfo({ locale: initialLocale }: HeaderInfoProps) {
  ...
  const t = await getTranslations({ locale, namespace: "Public.footer.HeaderInfo" });
