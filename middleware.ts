...
const SSO_HOSTS = ["sso.etheriatimes.localhost", "sso.etheriatimes.lan"];
const STUDIOS_HOSTS = ["studios.etheriatimes.localhost", "studios.etheriatimes.lan"];
const MAIN_HOSTS = ["etheriatimes.localhost", "etheriatimes.lan", "etheriatimes.com", "www.etheriatimes.com"];
...
function getDomainForGroup(group: DomainGroup, currentUrl: URL): string {
  ...
  if (IS_DEVELOPMENT) {
    switch (group) {
      case "sso":
        return `${protocol}//sso.etheriatimes.localhost`;
      case "studios":
        return `${protocol}//studios.etheriatimes.localhost`;
      case "main":
        return `${protocol}//etheriatimes.localhost`;
    }
  }

  switch (group) {
    case "sso":
      return `${protocol}//sso.etheriatimes.com`;
    case "studios":
      return `${protocol}//studios.etheriatimes.com`;
    case "main":
